...
import { useStockKardex, type KardexFilters } from "./use-stock-kardex"

export function KardexData() {
  const { user } = useAuth()
  const [filters, setFilters] = useState<KardexFilters>({ page: 1, perPage: 25 })
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex items-end justify-between gap-3">
        <KardexFiltersBar filters={filters} onChange={setFilters} />
