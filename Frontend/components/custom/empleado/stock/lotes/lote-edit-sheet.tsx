...
import { type LoteRow, updateLote } from "./use-stock-lotes"
    ...
    <Sheet open={open} onOpenChange={(v) => !v && onClose()}>
      <SheetContent side="right" className="w-full sm:max-w-md flex flex-col">
        <SheetHeader>
          ...
          <SheetDescription>
            Solo metadatos. La cantidad se ajusta mediante movimientos de stock.
          </SheetDescription>
        </SheetHeader>
        <Form {...form}>
          <form
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>Afecta el cálculo de valor de inventario.</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
